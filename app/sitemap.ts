...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes = ["", "/tools/image-converter", "/tools/image-compressor", "/tools/image-resizer", "/tools/pdf-merge", "/tools/pdf-split", "/tools/jpg-to-pdf", "/tools/pdf-to-jpg", "/privacy-policy", "/terms", "/disclaimer", "/contact"];
