...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes = ["", "/tools/image-converter", "/tools/image-compressor", "/tools/image-resizer", "/tools/pdf-merge", "/tools/pdf-split", "/tools/jpg-to-pdf", "/tools/pdf-to-jpg", "/tools/pdf-rotate", "/tools/pdf-compress", "/tools/qr-code-generator", "/tools/json-formatter", "/tools/case-converter", "/tools/remove-extra-spaces", "/tools/word-counter", "/privacy-policy", "/terms", "/disclaimer", "/contact"];
