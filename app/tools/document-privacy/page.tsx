...
const description = "Check what a PDF carries besides its visible pages, remove selected supported privacy traces locally, and verify the sanitized copy in your browser.";
...
const faqs = [
  ...
  { question: "What can this version remove?", answer: "It can create and verify a new copy without document metadata and XMP, embedded files, dangerous JavaScript or Launch actions, selected external URI actions, and selected review comments. Internal page links and non-URI actions are preserved." },
  { question: "What does Recommended Clean remove?", answer: "Recommended Clean selects detected metadata, embedded files, and dangerous active actions. It intentionally leaves comments and external links unselected because both can be useful document content." },
  { question: "Does a clean report guarantee the PDF is safe?", answer: "No. This is a bounded structural inspection, not a forensic certificate. Forms, hidden text, possible fake redactions, layers, image metadata, encrypted files, and proprietary structures have stated limits or remain inspection-only." },
