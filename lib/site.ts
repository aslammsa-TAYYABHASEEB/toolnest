...
export const categories: Category[] = [
  {
    ...
    availableDescription: "PDF Merge, PDF Split, PDF Rotate, and PDF Watermark organize and prepare documents, while JPG to PDF and PDF to JPG convert between documents and images entirely on your device.",
    icon: "PDF",
    accent: "coral",
  },
  {
