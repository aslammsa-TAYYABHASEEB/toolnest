...
export const tools: Tool[] = [
  { name: "Document Privacy Inspector", description: "Inspect PDF privacy traces and create a verified sanitized copy for supported categories.", category: "pdf-tools", icon: "SAFE", available: true, href: "/tools/document-privacy", keywords: ["document privacy inspector", "pdf privacy checker", "pdf metadata remover", "pdf sanitizer", "remove pdf attachments", "remove pdf javascript", "remove pdf comments", "check hidden text pdf", "pdf redaction checker"], relatedHrefs: ["/tools/searchable-pdf", "/tools/organize-pdf", "/tools/pdf-to-word"] },
